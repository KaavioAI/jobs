...
Kaavio is a data-intensive AI application. Behind every enriched catalog row is a long-running pipeline: a research agent on the web, structured extraction from a messy PDF, entity resolution across millions of SKUs. This role owns the systems that keep those pipelines reliable and affordable.
...
* $180k–$220k base, 0.25%–0.75% equity, depending on experience and location
* Flexible working hours and location (US-based)
* Health, dental, and vision coverage
* Generous vacation policy: take time when you need it
* Customer-facing from day one, with a direct path to technical leadership as the team scales

Apply by emailing [founders@kaavio.ai](mailto:founders@kaavio.ai); see the [README](README.md#apply) for what to include.
